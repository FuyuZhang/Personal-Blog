...
import com.gdufs.finalexam.dao.*;
import com.gdufs.finalexam.dao.*;
    ...
    private List<BlogListVO> getBlogListVOsByBlogs(List<Blog> blogList) {
        ...
        if (!CollectionUtils.isEmpty(blogList)) {
            List<Integer> categoryIds = blogList.stream()
                    .map(Blog::getBlogCategoryId).collect(Collectors.toList());
